...
;(function ( $, window, document, undefined ) {
  ...
  Plugin.prototype = {
    ...
    _reset: function() {
    	console.log('_reset');
    	heapBoxEl = $("div#heapbox_"+this.instance.heapId);
    	heapBoxEl.parent().removeClass('changed');

    	var rel0 = $('ul.heapOptions li:first-child a', heapBoxEl);

    	$('a.holder', heapBoxEl).attr('rel', 0).attr('data-user-selected', 0).text(rel0.text());

    	$('ul.heapOptions li a', heapBoxEl).removeClass('selected');
    	rel0.addClass('selected');
